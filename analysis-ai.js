...
(function() {
    ...
    const ACTIVITY_COLORS = {
        ...
        bus: '#4056B5', motorcycle: '#E35641', scooter: '#E07B67', airplane: '#8E1DD2',
            ...
            input_schema: {
                ...
                properties: {
                    ...
                    activity_types: {
                        type: 'array',
                        items: { type: 'string' },
                        description: 'Filter to only these activity types (e.g. ["walking","cycling"]). Omit to show all. Valid types: walking, running, hiking, cycling, car, bus, train, motorcycle, scooter, airplane, boat, skateboarding, inlineskating, snowboarding, skiing, horseback, surfing, tractor, tuktuk, stationary, unknown'
                    },
            ...
            input_schema: {
                ...
                properties: {
                    ...
                    activity_types: {
                        type: 'array',
                        items: { type: 'string' },
                        description: 'Filter to only these activity types (e.g. ["walking","cycling"]). Omit to show all moving activities. Valid types: walking, running, hiking, cycling, car, bus, train, motorcycle, scooter, airplane, boat, skateboarding, inlineskating, snowboarding, skiing, horseback, surfing, tractor, tuktuk, stationary, unknown'
                    },
                    mode: {
                        type: 'string',
